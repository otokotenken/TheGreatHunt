...
-(id)initWithTextHint: (NSString *)textHint andImageHint: (NSDictionary *)imageHint andLocationHint: (NSString *)locationHint andlocationHintRadius: (NSString *)locationHintRadius :(NSString *) gameRef : (NSString *)order;
@end
